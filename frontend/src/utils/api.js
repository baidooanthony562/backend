...
export const fetchMySupportThread = () => api.get('/support/my-thread');
...
export const replySupportMessage = (id, text) => api.post(`/support/messages/${id}/reply`, { text });
export const deleteSupportMessage = (id) => api.delete(`/support/messages/${id}`);
